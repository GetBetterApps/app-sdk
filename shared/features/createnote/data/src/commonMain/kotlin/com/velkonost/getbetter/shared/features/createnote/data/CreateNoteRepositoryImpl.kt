...
import com.velkonost.getbetter.shared.core.datastore.HINT_DIARY_CREATE_GOAL_SHOULD_SHOW
...
class CreateNoteRepositoryImpl(
    ...
    override suspend fun shouldShowGoalHint(): Boolean {
        val value = localDataSource.data.first()[HINT_DIARY_CREATE_GOAL_SHOULD_SHOW] != false
        localDataSource.edit { preferences ->
            preferences[HINT_DIARY_CREATE_GOAL_SHOULD_SHOW] = false
        }
