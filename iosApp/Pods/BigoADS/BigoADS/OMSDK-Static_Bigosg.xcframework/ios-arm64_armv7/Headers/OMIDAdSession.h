 ...
 */
@interface OMIDBigosgAdSession : NSObject

/**
 *  The AdSession configuration is used for check owners.
 */
@property(nonatomic, readonly) OMIDBigosgAdSessionConfiguration *configuration;
/**
 ...
 */
- (nullable instancetype)initWithConfiguration:(OMIDBigosgAdSessionConfiguration *)configuration
                              adSessionContext:(OMIDBigosgAdSessionContext *)context
...
- (BOOL)addFriendlyObstruction:(UIView *)friendlyObstruction
                ...
                detailedReason:(nullable NSString
