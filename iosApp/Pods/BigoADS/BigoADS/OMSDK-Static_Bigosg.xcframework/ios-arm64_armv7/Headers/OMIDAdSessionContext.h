 ...
 */
@interface OMIDBigosgAdSessionContext : NSObject
 ...
 * @see OMIDSDK
 */
- (nullable instancetype)initWithPartner:(OMIDBigosgPartner *)partner
                                 webView:(WKWebView *)webView
                              contentUrl:(nullable NSString
...
<OMIDBigosgVerificationScriptResource *> *)
resources
        contentUrl
:(
nullable NSString
