 ...
 */
@interface OMIDBigosgAdEvents : NSObject
 ...
 */
- (nullable instancetype)initWithAdSession:(nonnull OMIDBigosgAdSession
 ...
 */
- (BOOL)impressionOccurredWithError:(NSError *_Nullable
 ...
 *  When triggered all registered verification providers will be notified of this event.
 */
- (BOOL)loadedWithError:(NSError *_Nullable
 ...
 */
- (BOOL)loadedWithVastProperties:(OMIDBigosgVASTProperties *_Nonnull)vastProperties
