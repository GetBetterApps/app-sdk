...
__attribute__((deprecated("MTGInterstitialVideoAdManager is deprecated, and will be removed in the future release, use MTGNewInterstitialAdManager instead.")))
@interface MTGInterstitialVideoAdManager : NSObject

@property(nonatomic, weak) id <MTGInterstitialVideoDelegate> _Nullable
delegate;

@property(nonatomic, copy, readonly) NSString *_Nonnull
currentUnitId;

@property(nonatomic, copy, readonly) NSString *_Nullable
placementId;
...
- (nonnull instancetype)initWithPlacementId:(nullable NSString
...
*/
- (BOOL)isVideoReadyToPlayWithPlacementId:(nullable NSString
