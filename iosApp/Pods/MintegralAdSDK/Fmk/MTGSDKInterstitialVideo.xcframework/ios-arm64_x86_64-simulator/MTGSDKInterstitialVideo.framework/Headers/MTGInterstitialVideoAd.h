...
#define MTGInterstitialVideoSDKVersion @"7.5.6"
 ...
 */
- (void)onInterstitialVideoLoadFail:(nonnull NSError

*)
error adManager
:(
MTGInterstitialVideoAdManager *_Nonnull
)
adManager;
 ...
 */
- (void)onInterstitialVideoShowFail:(nonnull NSError
...
error adManager
:(
MTGBidInterstitialVideoAdManager *_Nonnull
)
adManager;
