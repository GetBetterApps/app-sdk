...
#define MTGSplashSDKVersion @"7.5.6"
 ...
 */
- (instancetype)initWithPlacementID:(nullable NSString
...
/**
 ...
 @note  You should always call this method on the main thread.
 */
- (void)showInKeyWindow:(UIWindow *)window customView:(nullable UIView
