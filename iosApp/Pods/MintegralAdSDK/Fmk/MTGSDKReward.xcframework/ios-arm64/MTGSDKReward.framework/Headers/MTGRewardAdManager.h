...
*/
- (void)loadVideoWithPlacementId:(nullable NSString
...
*/
- (void)showVideoWithPlacementId:(nullable NSString
...
/// @param unitId the unitId string
- (void)setExtraInfo:(id _Nullable)extraInfo forKey:(NSString *_Nonnull)key unitId:(NSString *_Nonnull)unitId;
