...
#define MTGRewardVideoSDKVersion @"7.5.6"
...
*/
- (void)onAdLoadSuccess:(nullable NSString
 ...
 *  @param unitId - the unitId string of the Ad that was loaded.
 */
- (void)onVideoAdLoadSuccess:(nullable NSString
 ...
 */
- (void)onVideoAdLoadFailed:(nullable NSString
 ...
 */
- (void)onVideoAdShowSuccess:(nullable NSString
 ...
 */
- (void)onVideoAdShowFailed:(nullable NSString
 ...
 */
- (void)onVideoPlayCompleted:(nullable NSString
 ...
 */
- (void)onVideoEndCardShowSuccess:(nullable NSString
 ...
 */
- (void)onVideoAdClicked:(nullable NSString
 ...
 */
- (void)onVideoAdDismissed:(nullable NSString
...
nullable NSString
*)
unitId withConverted
:(BOOL)
converted withRewardInfo
:(
nullable MTGRewardAdInfo
*)
rewardInfo;
 ...
 */
- (void)onVideoAdDidClosed:(nullable NSString
