...
#define MTGNewInterstitialSDKVersion @"7.5.6"
 ...
 */
- (void)newInterstitialAdLoadFail:(nonnull NSError

*)
error adManager
:(
MTGNewInterstitialAdManager *_Nonnull
)
adManager;
 ...
 */
- (void)newInterstitialAdShowFail:(nonnull NSError
 ...
 *  @param error       - error object that describes the exact error encountered when loading the ad.
 */
- (void)newInterstitialBidAdLoadFail:(nonnull NSError
 ...
 */
- (void)newInterstitialBidAdShowSuccessWithBidToken:(nonnull NSString
 ...
 *  @param error       - error object that describes the exact error encountered when showing the ad.
 */
- (void)newInterstitialBidAdShowFail:(nonnull NSError
