 ...
 */
- (void)setAppID:(nonnull NSString
...
- (void)setDeviceIdfa:(nonnull NSString
...
- (void)setDeviceIdfv:(nonnull NSString
...
- (void)setXcodeBuildVersion:(nonnull NSString
...
- (void)setUserInfo:(nonnull MTGUserInfo
 ...
 */
- (void)preloadNativeAdsWithPlacementId:(nullable NSString
 ...
 */
- (void)setUserPrivateInfoType:(MTGUserPrivateType)type agree:(BOOL)agree DEPRECATED_MSG_ATTRIBUTE

("Use `[MTGSDK sharedInstance] setConsentStatus:` instead");
...
DEPRECATED_MSG_ATTRIBUTE("Use `[MTGSDK sharedInstance] consentStatus` instead");
...
fbPlacementId
        forNumAdsRequested
:(NSUInteger)
numAdsRequested DEPRECATED_ATTRIBUTE;
...
autoCacheImage
        adCategory
:(MTGAdCategory)
adCategory DEPRECATED_ATTRIBUTE;
 ...
 */
- (void)preloadNativeFramesWithPlacementId:(nullable NSString
