...
@property(nonatomic, readonly) NSString *_Nullable
placementId;
 ...
 */
@property(nonatomic, weak) UIViewController *_Nullable
viewController;
 ...
 */
- (void)loadWithBidToken:(nonnull NSString
 ...
 */
- (void)registerViewForInteraction:(nonnull UIView
 ...
 */
- (void)unregisterView:(nonnull UIView
...
- (void)setExtraInfo:(nullable id)extraInfo forKey:(nonnull NSString
