...
static NSString
*
const MEDIATION_SDK_VERSION = @"7.7.0";
 ...
 */
+ (void)initWithAppKey:(NSString *)appKey delegate:(nullable id
 ...
 */
+ (void)initWithAppKey:(NSString *)appKey adUnits:(NSArray
 ...
 */
+ (void)initISDemandOnly:(NSString *)appKey adUnits:(NSArray
 ...
 */
+ (void)setLevelPlayRewardedVideoDelegate:(nullable id
 ...
 */
+ (void)setRewardedVideoManualDelegate:(nullable id

<ISRewardedVideoManualDelegate>)delegate
 ...
 */
+ (void)setLevelPlayInterstitialDelegate:(nullable id
 ...
 */
+ (void)setLevelPlayBannerDelegate:(nullable id
