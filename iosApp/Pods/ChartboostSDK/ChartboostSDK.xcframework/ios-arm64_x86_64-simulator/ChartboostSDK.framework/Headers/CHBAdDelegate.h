...
- parameter error: An error specifying the failure reason, or nil if the operation was successful.
 ...
 ```
 */
- (void)didCacheAd:(CHBCacheEvent *)event error:(nullable CHBCacheError
...
```
*/
- (void)didShowAd:(CHBShowEvent *)event error:(nullable CHBShowError
...
- parameter error: An error specifying the failure reason, or nil if the operation was successful.
 ...
 ```
*/
- (void)didClickAd:(CHBClickEvent *)event error:(nullable CHBClickError
...
- (void)didFinishHandlingClick:(CHBClickEvent *)event error:(nullable CHBClickError

*)error __attribute__((deprecated("Will be removed with the next major update")));
