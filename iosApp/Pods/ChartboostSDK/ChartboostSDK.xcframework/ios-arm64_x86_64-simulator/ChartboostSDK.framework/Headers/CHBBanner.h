...
FOUNDATION_EXPORT CHBBannerSize
const CHBBannerSizeStandard;
/*! "Medium Rect" - Medium banner size on phones. */
FOUNDATION_EXPORT CHBBannerSize
const CHBBannerSizeMedium;
/*! "Tablet" - Leaderboard banner size on tablets. */
FOUNDATION_EXPORT CHBBannerSize
const CHBBannerSizeLeaderboard;
...
- (instancetype)initWithSize:(CHBBannerSize)size
                    location:(NSString *)location
                   mediation:(nullable CHBMediation
...
*/
- (void)cacheBidResponse:(NSString *)bidResponse NS_SWIFT_NAME
