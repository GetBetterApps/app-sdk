...
- (void)e:(NSString *)message becauseOf:(nullable NSException
...
- (void)userError:(NSString *)message becauseOf:(nullable NSException
...
extern NSString *const kMAConfigKeyMuted
__deprecated_msg("Adapters no longer support mute APIs.");
@end
