...
*)tcfConsentStatusForVendorIdentifier:(NSInteger)
vendorIdentifier;
...
*)additionalConsentStatusForATPIdentifier:(NSInteger)
atpIdentifier;
...
<NSNumber *> *)al_numberArrayForKey:(NSString *)
key;
