 ...
 */
@property(nonatomic, strong, nullable) IBOutlet id
<ALAdLoadDelegate> adLoadDelegate;
 ...
 */
@property(nonatomic, strong, nullable) IBOutlet id
<ALAdDisplayDelegate> adDisplayDelegate;
 ...
 */
@property(nonatomic, strong, nullable) IBOutlet id
<ALAdViewEventDelegate> adEventDelegate;
 ...
 * @return A new instance of @c ALAdView.
 */
- (instancetype)initWithSize:(ALAdSize *)size zoneIdentifier:(nullable NSString
 ...
 * @return A new instance of @c ALAdView.
 */
- (instancetype)initWithSdk:(ALSdk *)sdk size:(ALAdSize *)size zoneIdentifier:(nullable NSString
