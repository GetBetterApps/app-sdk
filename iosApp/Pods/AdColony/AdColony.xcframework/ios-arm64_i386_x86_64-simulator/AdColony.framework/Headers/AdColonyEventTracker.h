...
FOUNDATION_EXPORT NSString
*
const ADCEventReservation;

/** Post-install search event */
FOUNDATION_EXPORT NSString
*
const ADCEventSearch;

/** Ad Impression event */
FOUNDATION_EXPORT NSString
*
const ADCEventAdImpression;

/** App Open event */
FOUNDATION_EXPORT NSString
*
const ADCEventAppOpen;
...
FOUNDATION_EXPORT NSString
*
const ADCCustomEventSlot1;
FOUNDATION_EXPORT NSString
*
const ADCCustomEventSlot2;
FOUNDATION_EXPORT NSString
*
const ADCCustomEventSlot3;
FOUNDATION_EXPORT NSString
*
const ADCCustomEventSlot4;
FOUNDATION_EXPORT NSString
*
const ADCCustomEventSlot5;
...
FOUNDATION_EXPORT NSString
*
const ADCRegistrationMethodDefault;
FOUNDATION_EXPORT NSString
*
const ADCRegistrationMethodFacebook;
FOUNDATION_EXPORT NSString
*
const ADCRegistrationMethodTwitter;
FOUNDATION_EXPORT NSString
*
const ADCRegistrationMethodGoogle;
FOUNDATION_EXPORT NSString
*
const ADCRegistrationMethodLinkedIn;
FOUNDATION_EXPORT NSString
*
const ADCRegistrationMethodOpenID;
FOUNDATION_EXPORT NSString
*
const ADCRegistrationMethodCustom;
...
FOUNDATION_EXPORT NSString
*
const ADCLoginMethodDefault;
FOUNDATION_EXPORT NSString
*
const ADCLoginMethodFacebook;
FOUNDATION_EXPORT NSString
*
const ADCLoginMethodTwitter;
FOUNDATION_EXPORT NSString
*
const ADCLoginMethodGoogle;
FOUNDATION_EXPORT NSString
*
const ADCLoginMethodLinkedIn;
FOUNDATION_EXPORT NSString
*
const ADCLoginMethodOpenID;
FOUNDATION_EXPORT NSString
*
const ADCLoginMethodCustom;
...
FOUNDATION_EXPORT NSString
*
const ADCSocialSharingMethodFacebook;
FOUNDATION_EXPORT NSString
*
const ADCSocialSharingMethodTwitter;
FOUNDATION_EXPORT NSString
*
const ADCSocialSharingMethodGoogle;
FOUNDATION_EXPORT NSString
*
const ADCSocialSharingMethodLinkedin;
FOUNDATION_EXPORT NSString
*
const ADCSocialSharingMethodPinterest;
FOUNDATION_EXPORT NSString
*
const ADCSocialSharingMethodYoutube;
FOUNDATION_EXPORT NSString
*
const ADCSocialSharingMethodInstagram;
FOUNDATION_EXPORT NSString
*
const ADCSocialSharingMethodTumblr;
FOUNDATION_EXPORT NSString
*
const ADCSocialSharingMethodFlickr;
FOUNDATION_EXPORT NSString
*
const ADCSocialSharingMethodVimeo;
FOUNDATION_EXPORT NSString
*
const ADCSocialSharingMethodFoursquare;
FOUNDATION_EXPORT NSString
*
const ADCSocialSharingMethodVine;
FOUNDATION_EXPORT NSString
*
const ADCSocialSharingMethodSnapchat;
FOUNDATION_EXPORT NSString
*
const ADCSocialSharingMethodCustom;
