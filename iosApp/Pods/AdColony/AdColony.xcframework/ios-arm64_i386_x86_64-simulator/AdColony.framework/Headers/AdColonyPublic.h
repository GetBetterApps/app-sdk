...
/**
 ...
 @see AdColonyZone
 */
+ (void)configureWithAppID:(NSString *)appID options:(nullable AdColonyAppOptions

*)
options completion
:(nullable void (^)(
NSArray<AdColonyZone *> *zones
))
completion;
 ...
 */
+ (void)configureWithAppID:(NSString *)appID zoneIDs:(NSArray

<NSString *> *)
zoneIDs options
:(
nullable AdColonyAppOptions
*)
options completion
:(nullable void (^)(
NSArray<AdColonyZone *> *zones
))completion __attribute__((deprecated("Deprecated in v4.8.0")));
 ...
 */
+ (void)requestInterstitialInZone:(NSString *)zoneID options:(nullable AdColonyAdOptions

*)
options andDelegate
:(
id <AdColonyInterstitialDelegate> _Nonnull
)
delegate;
...
/**
 ...
 @see AdColonyAdRequestError
 */
+ (void)requestAdViewInZone:(NSString *)zoneID withSize:(AdColonyAdSize)size andOptions:(nullable AdColonyAdOptions

*)
options viewController
:(UIViewController *)
viewController andDelegate
:(id <AdColonyAdViewDelegate>)
delegate;
...
/**
 ...
 @see AdColonyAdRequestError
 */
+ (void)requestAdViewInZone:(NSString *)zoneID withSize:(AdColonyAdSize)size options:(nullable AdColonyAdOptions

*)
options andDelegate
:(id <AdColonyAdViewAdvancedDelegate>)
delegate;
 ...
 */
+ (void)sendCustomMessageOfType:(NSString *)type withContent:(nullable NSString
 ...
 */
+ (void)iapCompleteWithTransactionID:(NSString *)transactionID productID:(NSString *)productID price:(nullable NSNumber
...
*/
+ (void)collectSignals:(nonnull void (^)(NSString

*
_Nullable signals, NSError
*
_Nullable error
))
completion;
