...
/**
 ...
 @return Whether the option was set successfully.
 */
- (BOOL)setMetadataWithKey:(NSString *)key andArrayValue:(NSArray
...
*)getStringMetadataWithKey:(NSString *)
key;
...
*)getNumericMetadataWithKey:(NSString *)
key;
...
*)getArrayMetadataWithKey:(NSString *)
key;
@end
