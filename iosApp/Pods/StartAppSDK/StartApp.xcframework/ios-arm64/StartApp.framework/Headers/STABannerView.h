 ...
 */
- (nullable id)initWithSize:(STABannerSize)size autoOrigin:(STAAdOrigin)autoOrigin adPreferences:(nullable STAAdPreferences

*)
adPreferences withDelegate
:(
nullable id
 ...
 * @return STABannerView instance
 */
- (nullable id)initWithSize:(STABannerSize)size autoOrigin:(STAAdOrigin)autoOrigin withDelegate:(nullable id

<STABannerDelegateProtocol>)
bannerDelegate withAdTag
:(
nullable NSString
*)
adTag __deprecated_msg(
        "adTag on impression is deprecated. Please provide adTag for ad request in STAAdPreferences object via initWithSize:autoOrigin:adPreferences:withDelegate: method.");
...
- (void)addSTABannerToCell:(UITableViewCell *)cell withIndexPath:(NSIndexPath *)indexPath atIntexPathSection:(NSInteger)section repeatEach:(NSInteger)each __deprecated_msg

("Will be removed in next SDK version");

- (void)addSTABannerToCell:(UITableViewCell *)cell withIndexPath:(NSIndexPath *)indexPath atIntexPathSection:(NSInteger)section __deprecated_msg

("Will be removed in next SDK version");

- (void)addSTABannerToCell:(UITableViewCell *)cell withIndexPath:(NSIndexPath *)indexPath atIntexPathRow:(NSInteger)row repeatEach:(NSInteger)each __deprecated_msg

("Will be removed in next SDK version");

- (void)addSTABannerToCell:(UITableViewCell *)cell withIndexPath:(NSIndexPath *)indexPath atIntexPathRow:(NSInteger)row __deprecated_msg
