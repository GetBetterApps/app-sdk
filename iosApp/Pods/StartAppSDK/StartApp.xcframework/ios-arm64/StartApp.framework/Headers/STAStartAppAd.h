 ...
 */
- (void)showAdWithAdTag:(NSString *)adTag __deprecated_msg

("adTag on impression is deprecated. Please provide adTag for ad request in STAAdPreferences object via loadVideoAdWithDelegate:withAdPreferences: method.");
